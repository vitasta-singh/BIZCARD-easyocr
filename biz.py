...
import re
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR",layout="wide",initial_sidebar_state="expanded")
...
background_image_url = "https://wallpapers.com/images/high/business-card-background-3597-x-2000-7x1r1nxch7xoyw00.webp"
...
mydb = pymysql.connect(
    host="localhost",
    user="root",
    password="Chunnu@123", database="bizcard")
